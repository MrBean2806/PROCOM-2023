...
set_property PACKAGE_PIN R5 [get_ports {i_btn[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {i_btn[0]}]
#Bank = 34, Pin name = IO_L20P_T3_34,						Sch name = SW5
set_property PACKAGE_PIN V7 [get_ports {i_btn[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {i_btn[1]}]
#Bank = 34, Pin name = IO_L20N_T3_34,						Sch name = SW6
set_property PACKAGE_PIN V6 [get_ports {i_btn[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {i_btn[2]}]
#Bank = 34, Pin name = IO_L10P_T1_34,						Sch name = SW7
set_property PACKAGE_PIN V5 [get_ports {i_btn[3]}]					
...
set_property PACKAGE_PIN T5 [get_ports {o_led_r[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_led_r[0]}]
#Bank = 34, Pin name = IO_L12N_T1_MRCC_34,					Sch	name = LED5
set_property PACKAGE_PIN T4 [get_ports {o_led_r[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_led_r[1]}]
#Bank = 34, Pin name = IO_L22P_T3_34,						Sch name = LED6
set_property PACKAGE_PIN U7 [get_ports {o_led_r[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_led_r[2]}]
#Bank = 34, Pin name = IO_L22N_T3_34,						Sch name = LED7
set_property PACKAGE_PIN U6 [get_ports {o_led_r[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_led_r[3]}]
#Bank = 34, Pin name = IO_L10N_T1_34,						Sch name = LED8
set_property PACKAGE_PIN V4 [get_ports {o_led_g[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_led_g[0]}]
#Bank = 34, Pin name = IO_L8N_T1_34,						Sch name = LED9
set_property PACKAGE_PIN U3 [get_ports {o_led_g[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_led_g[1]}]
#Bank = 34, Pin name = IO_L7N_T1_34,						Sch name = LED10
set_property PACKAGE_PIN V1 [get_ports {o_led_g[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_led_g[2]}]
#Bank = 34, Pin name = IO_L17P_T2_34,						Sch name = LED11
set_property PACKAGE_PIN R1 [get_ports {o_led_g[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_led_g[3]}]
#Bank = 34, Pin name = IO_L13N_T2_MRCC_34,					Sch name = LED12
set_property PACKAGE_PIN P5 [get_ports {o_led_b[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_led_b[0]}]
#Bank = 34, Pin name = IO_L7P_T1_34,						Sch name = LED13
set_property PACKAGE_PIN U1 [get_ports {o_led_b[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_led_b[1]}]
#Bank = 34, Pin name = IO_L15N_T2_DQS_34,					Sch name = LED14
set_property PACKAGE_PIN R2 [get_ports {o_led_b[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_led_b[2]}]
#Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = LED15
set_property PACKAGE_PIN P2 [get_ports {o_led_b[3]}]					
...
set_property PACKAGE_PIN C12 [get_ports i_reset]				
